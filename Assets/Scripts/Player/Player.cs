...
public class Player : Entity
{
    ...
    protected override void Awake()
    {
        ...
        m_IdleState = new PlayerIdleState(this, m_PlayerStateMachine, PlayerStatesAnimationHash.IDLE);
        m_MoveState = new PlayerMoveState(this, m_PlayerStateMachine, PlayerStatesAnimationHash.MOVE);
        m_JumpState = new PlayerJumpState(this, m_PlayerStateMachine, PlayerStatesAnimationHash.JUMP);
        m_AirState  = new PlayerAirState(this, m_PlayerStateMachine, PlayerStatesAnimationHash.JUMP);
        m_DashState  = new PlayerDashState(this, m_PlayerStateMachine, PlayerStatesAnimationHash.DASH);
        m_WallSlideState  = new PlayerWallSlideState(this, m_PlayerStateMachine, PlayerStatesAnimationHash.WALLSLIDE);
        m_WallJumpState  = new PlayerWallJumpState(this, m_PlayerStateMachine, PlayerStatesAnimationHash.JUMP);
        m_PrimaryAttackState = new PlayerPrimaryAttackState(this, m_PlayerStateMachine, PlayerStatesAnimationHash.ATTACK);
    }
